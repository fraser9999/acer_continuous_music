...
print("Please use latest Version gf4==6.8.2 for working correct")
print("")
...
def main(checkpoint_path, bf16, torch_compile, cpu_offload, overlapped_decode, device_id, output_path):
    ...
    while True:
        ...
        try: 
            ...
            print("")
            print("")
            print("No Connection to G4F Provider -WeWordle- ")
        ...
        # Fix Response Text if Re-Prompt and Markdown Columns in it
  
        if "markdown" in response_text:
            fixed_text = response_text.split("markdown",1)[1] 

        elif "---" in response_text:
 

            try:
                fixed_text = response_text.split("---",1)[1]
               

            except Exception as e:
                print("No markdown at beginning found...")
            ...
            try:
                ...
                print("No Markdown at the End found...")
                print(e)
                #fixed_text=response_text
                pass 
